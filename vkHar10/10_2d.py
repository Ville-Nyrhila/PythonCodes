...
class Auto:
    ...
    def __init__(self, tankin_koko, kulutus, kartan_koko):
    ...
    def __move__(self, komento):
        if self.__tankki < self.__kulutus:
            pass
        else:
            if komento == "P":
                if self.__y < self.__kartta:
                    self.__y += 1
                    self.__tankki -= self.__kulutus
            elif komento == "I":
                if self.__x < self.__kartta:
                    self.__x += 1
                    self.__tankki -= self.__kulutus
            elif komento == "E":
                if self.__y > 0:
...
def muotoile_auton_rivi(x = 1, kartan_koko = 4):
    ...
    return viiva
#
def tulosta_kartta(auto = Auto, kartan_koko = 0):
...
def main():
    ...
    auto = Auto(tankin_koko, kulutus, kartan_koko)
    ...
    while True:
        ...
        if komento == "T":
            ...
            tulosta_kartta(auto, kartan_koko)
